              ...
              <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul className="navbar-nav ml-auto mb-2 mb-lg-0">
                    ...
                    <li className="nav-item">
                      <NavLink activeClassName="menu-active" className="nav-link" to="/gallary">Gallary  </NavLink>
                    </li>
                    <li className="nav-item">
                      <NavLink activeClassName="menu-active" className="nav-link" to="/videos">Videos  </NavLink>
                    </li>
                    <li className="nav-item">
